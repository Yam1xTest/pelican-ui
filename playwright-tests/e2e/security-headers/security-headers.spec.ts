...
async function expectSecurityHeaders({
  ...
  console.log(`1234567898765432env`, process.env.CSP_ENABLED);
  // eslint-disable-next-line no-console
  console.log(`23456789098765bool`, process.env.CSP_ENABLED === `true`);
  // eslint-disable-next-line no-console
  console.log(`3345678987654headers`, headers[`content-security-policy`]);
